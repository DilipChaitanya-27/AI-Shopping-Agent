      ...
      <div className="relative z-10 w-full max-w-3xl p-4 backdrop-blur-md bg-white/80 dark:bg-black/70 rounded-xl shadow-lg">
        ...
        {cart.length === 0 ? (
          ...
          <>
                  ...
                  <div className="relative z-10 flex items-center gap-4 w-full">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="text-xs bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-3 py-2 rounded-lg hover:scale-105 transition"
                      >
                        Remove
                      </button>

                      <button
                        className="text-xs bg-orange-500 text-white px-3 py-2 rounded-lg hover:scale-105 hover:bg-orange-600 transition"
                      >
                        Buy Now
                      </button>
                    </div>
            ...
            {/* Summary */}
            <div className="mt-6 border-t border-orange-300/30 pt-4 flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  Items: {cart.length}
                </p>
              ...
              <button className="bg-orange-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-orange-600 hover:scale-105 transition">
                Buy All Now
              </button>
            </div>
          </>
